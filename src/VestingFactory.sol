...
contract VestingFactory is Ownable {
    ...
    event VestingScheduleCreated(address indexed vestingContract, address indexed beneficiary, uint256 totalAmount);
    ...
    function createVestingContractWithSchedule(
        ...
        emit VestingScheduleCreated(vestingContractAddress, _beneficiary, _totalAmount);
