...
deploy-omnichain-token:
  forge script script/DeployOmnichainToken.s.sol:DeployOmnichainToken --rpc-url base-sepolia --sender 0x25Fbb765998134400f6e2D4191e89C37dB40fa98 --account block-mentor-deployer --verify --broadcast
